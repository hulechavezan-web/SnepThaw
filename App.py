...
def primera_pantalla(page: ft.Page):
    ...
    image_layer = ft.Container(
        content=ft.Image(src="Recursos/prueba.png", width=450, height=450, fit="contain"),
        alignment=ft.Alignment(1, 0), 
    ...
    text_content = ft.Container(
        ...
        content=ft.Column(
            [
                ft.Text("HEAT-CALICO", color="#b71c1c", size=55, weight="bold", font_family="Arial Black"),
                ft.Container(height=10),
                ft.ElevatedButton(
                    content=ft.Text("Inicio", color="white", size=22),
                    bgcolor="#424242", width=240, height=65, elevation=8,
...
def segunda_pantalla(page: ft.Page):
    ...
    layout_principal = ft.Column(
        [
            ft.Container(
                content=ft.Text("Segunda Pantalla", color="black", size=35, weight="bold"),
            ...
            ft.Container(
                content=ft.ElevatedButton(
                    ...
                    bgcolor="#424242", width=160, height=50,
    ...
    layout_operacion = ft.Container(
        ...
        content=ft.Column(
            [
                ...
                ft.Row([
                    ft.Text("Operacion Enfriamiento", size=26, weight="bold", color="#b71c1c"),
                    ft.ElevatedButton("Volver", on_click=lambda _: segunda_pantalla(page))
...
def cuarta_pantalla(page: ft.Page):
    ...
    page.add(
        ft.Stack(
            [background_gradient, layout_final], 
            expand=True
        )
    )
    page.update()
